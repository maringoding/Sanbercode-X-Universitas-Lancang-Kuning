...
class castController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            'nama.required' => 'Nama harus terisi,tidak boleh kosong ya',
            'umur.required' => 'Umur harus terisi tidak boleh kosong ya',
            'bio.required' => 'Bio harus diisi seperlunya saja ya',
        ]);
        $cast = new Cast;
